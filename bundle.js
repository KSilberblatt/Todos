...
var _todos_reducer = __webpack_require__(39);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    receiveTodos: function receiveTodos(todo) {
      return dispatch((0, _todos_reducer.receiveTodos)(todo));
    }
  };
};
...
var _unique_id = __webpack_require__(176);
...
var TodoForm = function (_Component) {
  ...
  _createClass(TodoForm, [{
    ...
    value: function handleClick(ev) {
      ...
      var dispatchReceiveTodo = function dispatchReceiveTodo() {
        window.store.dispatch((0, _todo_actions.receiveTodo)(_this2.state));
      };

      this.setState({
        id: (0, _unique_id.uniqueId)()
      }, dispatchReceiveTodo);
    }
  }, {
    ...
    value: function handleInputChange(ev) {
      ...
      this.setState(_defineProperty({}, target, targetValue));
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          null,
          'Title',
          _react2.default.createElement('input', { id: 'title', onChange: this.handleInputChange, type: 'text' })
        ),
        _react2.default.createElement('br', null),
        _react2.default.createElement(
          'label',
          null,
          'Body',
          _react2.default.createElement('input', { id: 'body', onChange: this.handleInputChange, type: 'text' })
        ),
        _react2.default.createElement('br', null),
        _react2.default.createElement(
          'button',
